...
| --- | --- | --- |
| `<set-slug>` | Set-Id aus dem Wurzel-`manifest.yaml` (z. B. `psych-beeinflussung-from-de`) oder der Ordnername des Set-Pfads (z. B. `psych-beeinflussung` für `sets/de/psych-beeinflussung`) | Pflicht |
...
# Grosses Set: in Teile von je hoechstens 10 Lektionen aufteilen, fuer eine
