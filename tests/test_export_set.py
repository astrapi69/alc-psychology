...
* the manifest set id (``psych-beeinflussung-from-de``) resolves the same
  set as the path basename slug (``psych-beeinflussung``).
"""
...
KNOWN_SLUG = "psych-beeinflussung"
KNOWN_MANIFEST_ID = "psych-beeinflussung-from-de"
KNOWN_SET_DIR = REPO_ROOT / "sets" / "de" / "psych-beeinflussung"
